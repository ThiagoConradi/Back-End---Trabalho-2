...
db.sequelize.sync({ force: true }).then(async() => {
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2021-12-15T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2008-11-20T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2010-10-25T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2015-09-08T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2018-08-07T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2024-03-11T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2023-03-04T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2022-04-11T03:24:00')
    });
    ...
    await RespostaDAO.create({
        ...
        dataHora: new Date('2022-11-02T03:24:00')
    });
